        ...
        <div className='banner-img'>
            <div className='w-100 d-flex justify-content-center align-items-center h-100 text-white '>
                <div className='banner-info'>
                    ...
                    <p className=''>
                    Immigration consultants help people immigrate from one country to another for study, work, travel or business purpose. I provide legal services in the area of immigration law as permitted by legislation.
                    </p>
